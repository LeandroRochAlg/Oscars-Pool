    ...
    <footer className="footer bg-info text-secondary p-10">
      ...
      <nav>
        ...
        <div className="grid grid-flow-col gap-4">
          {/* GitHub */}
          <a href="https://github.com/leandrorochalg" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/leandro-rocha-258b90198/" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          {/* Instagram */}
          <a href="https://instagram.com/leandrorochalg" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          {/* Letterboxd */}
          <a href="https://letterboxd.com/leandrorochalg" target="_blank" rel="noopener noreferrer">
            <img
              src="/assets/logos/letterboxd.svg"
              alt="Letterboxd Logo"
        ...
        <div>
          <h6 className="footer-title">{t('contact')}</h6>
            <p>
              <a href="mailto:leandrochaju@hotmail.com">leandrochaju@hotmail.com</a>
            </p>
        </div>
    </footer>
  );
